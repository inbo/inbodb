...
#'
#' This method is an adaptation to the INBO databases from the eponymous function in the `odbc` package and is an implementation of the method `dbdbDisconnect` defined in the `DBI` package.
#'
