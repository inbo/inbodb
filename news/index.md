...
- [`get_florabank_taxon_ifbl_year()`](https://inbo.github.io/inbodb/reference/get_florabank_taxon_ifbl_year.md)
  now also returns the month
- [`get_florabank_taxon_ifbl_year()`](https://inbo.github.io/inbodb/reference/get_florabank_taxon_ifbl_year.md)
  `SQL` edge case fixed

## inbodb 0.0.11

- improve performance of establishing a connection with
  [`connect_inbo_dbase()`](https://inbo.github.io/inbodb/reference/connect_inbo_dbase.md)
- add `timeout` as an argument in
  [`connect_inbo_dbase()`](https://inbo.github.io/inbodb/reference/connect_inbo_dbase.md)
- minor documentation update (issue
  [\#74](https://github.com/inbo/inbodb/issues/74))
