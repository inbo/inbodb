...
This time we will not use `collect = TRUE`, which will return a [lazy query](https://dbplyr.tidyverse.org/reference/tbl.src_dbi.html):
...
save(
  ...
  relations_n2000meetnet,
  survey_info,
  file = "get_data_inboveg_results.Rda"
)
```
