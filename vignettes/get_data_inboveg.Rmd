...
## Layer information
This function `get_inboveg_layerinfo` queries the INBOVEG database for layer information on recordings  for one or more surveys.
...
## Layer qualifiers
This function `get_inboveg_layerqualifier`queries the INBOVEG database for layer qualifier information on recordings  for one or more surveys.
