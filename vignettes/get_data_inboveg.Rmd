...
head(header_info, 10)
# A tibble: 10 x 16
# RecordingGivid NeedsWork Name  UserReference Observer LocationCode Latitude Longitude  Area Length Width VagueDateType
#    <chr>              <int> <chr> <chr>         <chr>    <chr>           <dbl>     <dbl> <dbl>  <int> <int> <chr>        
#  1 IV20160210121~         0 Oude~ 5             Alex Ve~ Ekeren           51.3      4.43    10     NA    NA Y            
#  2 IV20160210140~         0 Oude~ 1             Alex Ve~ Ekeren           51.3      4.43    25     NA    NA Y            
#  3 IV20160210142~         0 Oude~ 2             Alex Ve~ Ekeren           51.3      4.43    25     NA    NA Y            
#  4 IV20160210153~         0 Oude~ 4             Alex Ve~ Ekeren           51.3      4.43    12     NA    NA Y            
#  5 IV20160210155~         0 Oude~ 81            Alex Ve~ Ekeren           51.3      4.43     9     NA    NA Y            
#  6 IV20160210160~         0 Oude~ 20            Alex Ve~ Ekeren           51.3      4.43     9     NA    NA Y            
#  7 IV20160210161~         0 Oude~ 17            Alex Ve~ Ekeren           51.3      4.43    12     NA    NA Y            
#  8 IV20160210162~         0 Oude~ 19            Alex Ve~ Ekeren           51.3      4.43    12     NA    NA Y            
#  9 IV20160210163~         0 Oude~ 18            Alex Ve~ Ekeren           51.3      4.43    12     NA    NA Y            
# 10 IV20160210164~         0 Oude~ 23            Alex Ve~ Ekeren           51.3      4.43     6     NA    NA Y            
# ... with 4 more variables: VagueDateBegin <chr>, VagueDateEnd <chr>, SurveyId <int>, RecTypeID <int>
```
