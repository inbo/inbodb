...
```
Optionally observers can also record non target species that can be counted using the
same protocol.
...
[waarnemingen.be](https://www.waarnemingen.be).
...
results.
This way we can inform you how to properly acknowledge the different project
parters of [meetnetten.be](https://www.meetnetten.be).
