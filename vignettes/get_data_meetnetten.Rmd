...
consists of set of monitoring schemes for priority species in Flanders, the 
...
As an INBO employee, you should make sure you have reading-rights for the INBO 
DWH Server, otherwise place an ICT-call.
