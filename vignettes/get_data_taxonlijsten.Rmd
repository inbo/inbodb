...
select(c('RL','Taxonlijst', 'PublicatieJaar', 'Criteria', 'Validering', 'Vaststelling'))
```
...
select(c('Publicatiejaar', 'Naamwet_interpretatie', 'NaamNed_interpretatie', 'KenmerkwaardeCode')) %>%
